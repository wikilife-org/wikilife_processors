...
from wikilife_processors.processors.stats.was.factors.factors_model import HeadacheFactor


class HeadacheFactorTests(BaseTest):
    """
    ...
    def test_process_value(self):
        factor = HeadacheFactor(daos=self._daos, values=[
