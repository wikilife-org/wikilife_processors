...
from wikilife_processors.processors.stats.was.factors.factors_model import MoodFactor


class MoodFactorTests(BaseTest):
    """
    Further testing on super class WeeklyAvgAvgFactor
    """
